...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative flex flex-col items-center w-full max-w-md">
        {/* Header */}
      <button className="relative mb-5  rounded-full p-2 flex justify-center items-center group">
  {/* Gradient border */}
  ...
  {/* Inner content */}
  <div  className="relative flex justify-center items-center bg-white dark:bg-gray-900 rounded-full w-18 h-18">
    <img src="/lumiHead.svg" alt="Description" className="w-18 h-18 rounded-full" />
  </div>
</button>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white font-medium transition-all duration-200">
